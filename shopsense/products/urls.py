...
from . import views
from .views import ProductListAPI, ReviewListAPI, ClickListAPI
...
urlpatterns = [
    ...
    path('api/reviews/', ReviewListAPI.as_view(), name='api_reviews'),
    path('api/clicks/', ClickListAPI.as_view(), name='api_clicks'),
]